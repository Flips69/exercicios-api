...
class ExercicioUmForRequest extends FormRequest
{
    ...
    public function messages(){
        ...
        return [
            ...
            'primerio_numero.numeric' => 'O campo é somente números',
            'segundo_numero.required' => 'Preencha o cmapo segundo número',
            'segundo_numero.numeric' => 'O campo é somento números',
        ];
    }
}
